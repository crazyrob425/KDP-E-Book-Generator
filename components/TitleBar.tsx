  ...
  return (
    <div className="h-8 bg-slate-900 flex items-center justify-between select-none fixed top-0 left-0 right-0 z-[100] border-b border-slate-700">
      ...
      <div className="flex items-center h-full" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
        ...
        {menuOpen && (
          <div
            className="absolute top-8 left-0 mt-1 bg-slate-900 border border-slate-700 rounded-md shadow-lg w-48"
      ...
      {/* Draggable centre title */}
      <div
        className="flex-grow h-full flex items-center px-4"
      ...
      {/* Window controls */}
      <div
        className="flex h-full border-l border-slate-700"
        style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}
      >
        <button
